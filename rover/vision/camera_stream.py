...
class CameraStream:
    ...
    def _setup_camera(self):
        ...
        try:
            ...
            logger.warning(f"picamera2 not available: {e}, using OpenCV fallback")
    ...
    def get_frame(self):
        ...
        try:
            if self.camera_type == 'picamera2':
                # Use the correct capture method for picamera2
                ...
                # Convert to RGB if needed (picamera2 returns BGR by default)
        ...
        while self.is_streaming:
            try:
                ...
                if frame is not None:
                    ...
                    cv2.putText(blank_frame, f'No Camera - Frame {frame_count}', (50, 240), 
                ...
                cv2.putText(error_frame, f'Camera Error: {str(e)[:30]}', (50, 240), 
